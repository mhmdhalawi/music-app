...
<template>
  ...
  <div
    ...
    id="modal"
    :class="{ hidden: !store.authModalShow }"
  >
    <div
      ...
      >
        ...
        <div class="py-4 text-left px-6">
          ...
          <div class="flex justify-between items-center pb-4">
            ...
            <!-- Modal Close Button -->
            <div class="modal-close cursor-pointer z-50" @click.prevent="store.toggleAuthModal">
          ...
          <ul class="flex flex-wrap mb-4">
            ...
            <li class="flex-auto text-center">
              <a
                ...
                @click.prevent="tab = 'RegisterForm'"
                >Register</a
              >
            </li>
          </ul>
